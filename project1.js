...
k=k+1;
      ...
      if (txtValue==="Farah Sherry") {
        ...
        if (txtValue==="Ali Mustafa") {
          ...
          if (txtValue==="Aya Saker") {
            ...
            if (txtValue==="Mohammad Ali Mansour") {
  ...
  function toggleColumns() {
    ...
    // Loop through each cell and toggle the hidden ones
